...
description: "Everyone squints at the same spreadsheet for thirty seconds before they find the number that matters. The math is fine — nothing on screen tells you where to look. So I rebuilt it as a dashboard."
date: 2026-07-13
...
That's the whole case for a dashboard, underneath the buzzwords. The numbers were fine. Nobody could find the one that mattered.
...
Neither panel is lying. I want to be careful about that, because it's tempting to talk about spreadsheets like they're deceptive, and they're not. The numbers are identical in both, always. What changed is that the dashboard does the work of pointing, and the spreadsheet leaves that work to you.

## The part that's easy to get wrong

Here's where a lot of dashboards quietly fail, even good-looking ones: they animate the destination and skip the journey. A bar that just appears, fully grown, teaches you nothing about where the number came from. That's a spreadsheet wearing a nicer shirt.
...
<ul class="checklist">
<li><span class="tick" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12.5l4 4L19 6.5"/></svg></span><span>Find the spreadsheet in your own work that everyone squints at before a meeting. That's your dashboard candidate.</span></li>
...
<li><span class="tick" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12.5l4 4L19 6.5"/></svg></span><span>Ask what a stranger would notice first, with no context. If the real answer is "nothing in particular," the spreadsheet hasn't finished becoming a dashboard yet.</span></li>
</ul>
