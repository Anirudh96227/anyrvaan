...
<ul class="checklist">
<li><span class="tick" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12.5l4 4L19 6.5"/></svg></span><span>Count the type sizes in your current project. If it's more than eight or nine, you probably have duplicates doing the same job — merge them.</span></li>
